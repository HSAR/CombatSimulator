...
internal class TacticalActionStrategyTest {
    ...
    fun decideTurnActions() {
        ...
        val feasibleActions: List<TargetedAction> = TacticalActionStrategy.decideTurnActions(world, unit, listOf(meleeAttack, singleRangedAttack, chargeAttack, aimAction))
